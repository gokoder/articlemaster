...
import (
	...
	"github.com/gokoder/articlemaster/model"
	"github.com/gokoder/articlemaster/repository"
...
func init() {
	Logger = log.New(os.Stdout, "github.com/gokoder/handler:", log.Ldate|log.Ltime)
}
